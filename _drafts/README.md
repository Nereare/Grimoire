...
| `attacks`          | :heavy_check_mark: | `array` of `object`  | An array of objects, each element being one attack, at least one element is required |
...
| `possessions`      | :x:                | `array` of `objects` | An array of objects, each element being a different item                             |
